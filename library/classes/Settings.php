...
class Settings {
	 ...
	 * @var string
	 */
	private $key = 'digia_wp_base_options';
	...
	public function option_fields() {
		 ...
		 */
		$this->option_metabox[] = [
			'id'         => 'digia_wp_base_general_options',
			'title'      => __( 'General options', TEXT_DOMAIN ),
			'show_on'    => [ 'key' => 'options-page', 'value' => [ 'digia_wp_base_general_options' ], ],
			'show_names' => true,
			'fields'     => [
				[
				...
				[
					...
					'desc'    => __( 'define default post image if no images are attached to post / page',
						TEXT_DOMAIN ),
					'id'      => 'digia_wp_base_default_image',
					'default' => '',
					'type'    => 'file',
				],
			]
		...
		$this->option_metabox[] = [
			'id'         => 'digia_wp_base_advanced_options',
